...
public class WordsInCorpusTFIDFReducer extends Reducer<Text, Text, Text, Text> {
	 ...
	 *
	 *            PRECONDITION: receive a list of <word, ["doc1=n1/N1",
	 *            "doc2=n2/N2"]> POSTCONDITION: <
	 *            "word@doc1,  [d/D, n/N, TF-IDF]">
	 */
	protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
		...
		for (String document : tempFrequencies.keySet()) {
			...
			double tf = Double.valueOf(
					Double.valueOf(wordFrequenceAndTotalWords[0]) / Double.valueOf(wordFrequenceAndTotalWords[1]));
			...
			context.write(new Text(key + "@" + document),
					new Text("[" + numberOfDocumentsInCorpusWhereKeyAppears + "/" + numberOfDocumentsInCorpus + " , "
